...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cataloniacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ns1.cataloniacoin.cat", "ns1.cataloniacoin.cat"},
    {"ns2.cataloniacoin.cat", "ns2.cataloniacoin.cat"},
    {"ns3.cataloniacoin.cat", "ns3.cataloniacoin.cat"},
    {"cataloniacoin.cat", "cataloniacoin.cat"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testnet-seed.cataloniacoin.cat", "testnet-seed.cataloniacoin.cat"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cataloniacoin is probably already running."), addrBind.ToString().c_str());
        else
